                        ...
                        <li class="bg-gray-100 p-10 grid grid-cols-2 mb-10">
                            ...
                            <div class="flex items-center h-full px-20">
                                <div>
                                    ...
                                    <a class="text-primary hover:text-secondary underline transition duration-700 ease-in-out hover:no-underline" href="<?php the_field('shop_url'); ?>" title="<?php the_title(); ?>">aa<?php the_field('shop_url'); ?></a></h6>
                                </div>
                            </div>
                        </li>
