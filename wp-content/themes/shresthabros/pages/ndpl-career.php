...
<main id="primary">
    ...
    <div class="max-w-screen-xl mx-auto px-4 py-20 md:pb-40 md:text-center" data-scroll-section>
        <h2 class="text-4xl font-medium"><?php the_field('our_values_title'); ?></h2>
